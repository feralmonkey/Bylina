-- Load a different tilemap image depending on time
local current_system_hour = os.date("*t").hour -- Got an error, had to load sol::lib::os
            ...
            components = {
                ...
                on_update_script = {
                    ...
                    function(entity, delta_time, ellapsed_time)
                        local current_position_x, current_position_y = get_position(entity) -- this will be a c++ function that returns an entity position
